  ...
  return (
    <Form labelCol={{ span: 4 }} wrapperCol={{ span: 14 }} >
      ...
      <Form.Item name="chartList" label="Chart Types">
        <Checkbox.Group>
          <Row>
            <Checkbox.Group style={{ fontSize: 20 }} options={CHART_TYPES} value={types} onChange={onTypesChange} />
          </Row>
        </Checkbox.Group>
      </Form.Item>
      <Form.Item labelCol={{ span: 4 }} wrapperCol={{ span: 14 }}  label="Render Data Size">
      ...
      {useType === 'pc' ? <Form.Item wrapperCol={{ span: 4, offset: 4 }}>
