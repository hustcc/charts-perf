...
export const Content = () => {
  ...
  function onInputNumberChange(newValue: OneDataType, index: number) {
    ...
    console.log(getUseType(), 'getUseType()')
        ...
        {loading && (
          <div>
            <div
              id="modalBody"
              className="modalBody"
              style={getUseType() === 'pc' ? { width: 900, height: 600 } : { width: '100%', height: '100%', borderRadius: 0, justifyContent: 'space-between' }}
            >
